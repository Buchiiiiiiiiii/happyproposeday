...
function drawText() {
  ...
  if (frameNumber > 600 && frameNumber < 900) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        ["nee ala yavag ind life le bandi ala,", "aagind life full cute agogid"],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
        lineHeight
  ...
  if (frameNumber >= 900 && frameNumber < 1200) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        ["kadige ala gandaa ivatt ala,", "propose day"],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
        lineHeight
  ...
  if (frameNumber > 1200 && frameNumber < 1500) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "Na ig ning propose madti kel, I Love You Namanaaaaaa ",
      canvas.width / 2,
      canvas.height / 2
    );
    opacity = opacity + 0.01;
  ...
  if (frameNumber > 1800 && frameNumber < 2100) {
    context.fillStyle = `rgba(255, 255, 255, ${opacity})`;
    context.fillText(
      "nee nan life da bestestestest person gutt!!, Thank you for everything !!",
      canvas.width / 2,
      canvas.height / 2
    );
    opacity = opacity + 0.01;
  ...
  if (frameNumber > 2400 && frameNumber < 2700) {
    ...
    if (window.innerWidth < 600) {
      ...
      context.fillText(
        "ibru yavagu hinge santige,cute cute aag iru",
        canvas.width / 2,
        canvas.height / 2
      );
    }
